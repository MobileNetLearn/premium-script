...
echo "<pre>Setup by Miku | telegram @systemless_root | thanks for using</pre>" > /home/vps/public_html/index.php
...
clear
# SELASAI SUDAH BOSS! ( Mikus )
echo "========================================"  | tee -a log-install.txt
echo "Service Autoscript Miku (Miku SCRIPT 2017)"  | tee -a log-install.txt
echo "----------------------------------------"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
